<template>
  <el-table
    :data="$store.state.aimedison.keywordShopAimedison"
    v-if="$store.state.aimedison.keywordShopAimedison.length > 0"
  ...
  >
    ...
    <el-table-column width="50" align="center">
      <template slot-scope="{ row }">
        <el-button
          type="button"
          @click="removeTargetKeyword(row.keywordId)"
          style="background-color: skyblue; color: black; padding: 3px"
          >삭제</el-button
        >
